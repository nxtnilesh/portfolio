...
const highlights = [
  ...
  },
  {
    ...
    title: "Collaboration",
    description:
      "Working effectively in teams to deliver projects on time and within scope.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-3 -right-3 glass rounded-xl p-6 text-center "
            >
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-3xl font-bold">Crafting Digital Experiences</h3>
